...
function exp_VZC_Aquifer_2rule0_eval_expression(context) {
    // 
...
function exp_VZC_Aquifer_2rule1_eval_expression(context) {
    // AQUIFER = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.properties['AQUIFER']  == 1);
    } else {
        return (feature['AQUIFER']  == 1);
    }
}


function exp_VZC_Aquifer_2rule2_eval_expression(context) {
    // AQUIFER = 2

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.properties['AQUIFER']  == 2);
    } else {
        return (feature['AQUIFER']  == 2);
    }
}
...
function exp_VZC_Cities_7rule0_eval_expression(context) {
    // POP2010 > 0

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.properties['POP2010']  > 0);
    } else {
        return (feature['POP2010']  > 0);
    }
}